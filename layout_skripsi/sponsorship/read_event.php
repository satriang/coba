...
WHERE sponsorship.id_sponsorship = '{$id_sponsorship}' LIMIT $posisi,$batas";

$eksekusi = mysqli_query($conn, $sql);
//var_dump(array_values($eksekusi));
// sql read pengajuan event
$sql_event_didanai = "SELECT pengajuan_event.id_pengajuan_event, pengajuan_event.id_event, event.nama_event, event.id_event_creator, event_creator.nama_eo, pengajuan_event.dana_event, pengajuan_event.status
 FROM `pengajuan_event` 
JOIN event ON pengajuan_event.id_event = event.id_event 
JOIN sponsorship ON pengajuan_event.id_sponsorship = sponsorship.id_sponsorship
JOIN event_creator ON event.id_event_creator = event_creator.id_event_creator
            ...
            <table class="w3-table-all w3-hoverable">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="w3-center"><a href="detail_event.php?id_event=<?php echo $row['id_event'] ?>">
                    <?php echo $row['id_event'] ?></a></td>
                  <td class="w3-center"><a href="detail_event.php?id_event=<?php echo $row['id_event'] ?>"><?php echo $row['nama_event'] ?></a></td>
              ...
              $sql2 = "SELECT pengajuan_event.id_pengajuan_event, pengajuan_event.id_event, event.nama_event,       event.id_event_creator, event_creator.nama_eo, pengajuan_event.dana_event, 
                        pengajuan_event.status
                        FROM `pengajuan_event` 
                        JOIN event ON pengajuan_event.id_event = event.id_event 
                        JOIN sponsorship ON pengajuan_event.id_sponsorship = sponsorship.id_sponsorship
                        JOIN event_creator ON event.id_event_creator = event_creator.id_event_creator
            ...
            <table class="w3-table-all w3-hoverable">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="w3-center"><a href="detail_event.php?id_event=<?php echo $row2['id_event'] ?>">
                    <?php echo $row2['id_event'] ?></a></td>
                  <td class="w3-center"><a href="detail_event.php?id_event=<?php echo $row2['id_event'] ?>"><?php echo $row2['nama_event'] ?></a></td>
                  <td class="w3-center"><?php echo $row2['id_event_creator'] ?></td>
                  <td class="w3-center"><?php echo $row2['nama_eo'] ?></td>
                    <td class="w3-center"><label style="float: right;"><?php $hasil_rupiah = "Rp " . number_format($row2['dana_event'],2,',','.'); echo $hasil_rupiah;?></label></td>
            ...
            <table class="w3-table-all w3-hoverable">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="w3-center"><?php echo $row3['id_event_creator'] ?></td>
                  <td class="w3-center"><?php echo $row3['nama_eo'] ?></td>
