  ...
  <div class="col-9 col-s-9">
      <table border="0">
        <form action="update_proses_danai_event.php" method="post"  enctype="multipart/form-data">
          <tr>
            <td style="font-weight: bold;">ID PENGAJUAN EVENT</td>
            <td><input type="text" class="form-control" name="id_pengajuan_event" value="<?php echo $row_pengajuan['id_pengajuan_event'] ?>" /> </td>
          </tr>
          <tr>
            <td style="font-weight: bold;">EVENT</td>
            <td><input type="text" class="form-control" name="event" value="<?php echo $row_pengajuan['id_event']. ' || '. $row_pengajuan['nama_event'];  ?>"/> </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <input type="submit" class="w3-button w3-border w3-medium w3-teal" value="Danai" /></td>
          </tr>
         </form>
