...
$sql ="SELECT sponsorship.id_sponsorship, user.id_user, user.email, sponsorship.nama_sponsorship, sponsorship.alamat, sponsorship.no_telp, sponsorship.dana_maksimal, sponsorship.deskripsi_sponsorship FROM `sponsorship` JOIN user on sponsorship.id_user = user.id_user WHERE id_sponsorship = '{$id_sponsorship}' ";
 ...
 <div class="col-9 col-s-9">
  ...
  <div class="col-2 col-s-3 menu " style="text-align:center; font-weight: bold;">
    ...
    <div class="well">
     ...
     <a href="form_pengajuan.php?id_sponsorship=<?php echo $row['id_sponsorship'] ?>"  class="w3-button w3-border w3-small w3-purple">Ajukan</a>
    </div>
  </div>
