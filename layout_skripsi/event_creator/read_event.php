            ...
            <table class="w3-table-all w3-hoverable">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="w3-center"><a href="detail_sponsorship.php?id_sponsorship=<?php echo $row2['id_sponsorship'] ?>"><?php echo $row2['id_sponsorship'] ?></td>
                  <td class="w3-center"><a href="detail_sponsorship.php?id_sponsorship=<?php echo $row2['id_sponsorship'] ?>"><?php echo $row2['nama_sponsorship'] ?></td>
